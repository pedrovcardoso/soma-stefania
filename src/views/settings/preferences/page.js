...
import { MdFormatSize, MdPalette, MdRestore } from 'react-icons/md';
...
                    className="flex items-center gap-2 text-sm font-medium text-text-secondary hover:text-accent transition-colors px-3 py-1.5 rounded-lg hover:bg-surface-alt border border-transparent hover:border-border"
